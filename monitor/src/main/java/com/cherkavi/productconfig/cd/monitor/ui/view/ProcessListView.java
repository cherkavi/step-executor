package com.cherkavi.productconfig.cd.monitor.ui.view;

import com.cherkavi.productconfig.cd.monitor.domain.DeployStatus;
import com.cherkavi.productconfig.cd.monitor.repository.DeployStatusRepository;
...
//        columnFileSize.setRenderer(buttonRenderer);
    ...
    private void gotoLink(DeployStatus source) {
        String link = "http://"+host+":"+source.getPort();
